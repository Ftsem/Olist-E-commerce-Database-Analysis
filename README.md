...
Olist is a Brazilian Startup with funding from multiple large banks and companies. It serves a similar niche as Amazon marketplace, connecting small and large sellers to customers on a single website, handling logistics of getting products to the customer from the seller. I have analyzed the provided data from 2016 to 2018 to offer data-driven improvements to business operations and strategy.
